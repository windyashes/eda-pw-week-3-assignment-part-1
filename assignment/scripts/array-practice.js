...
let favoriteFoods = ['noodles', 'chips', 'licorice'];
...
console.log('animal array + last animal: ', animalArray, lastAnimal);
...
/* oh, I already did that. Well, I used the numberOfAnimals variable that was created earlier that uses the animalArray.length, so I guess I'll do it differently down here. */
...
let entree = 'spicy chicken sandwich';
...
gems[1] = 'Tourmaline';
console.log('Second gem should be tourmaline: ', gems[1]);
